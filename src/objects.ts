...
function createBook(
  ...
  return myBooks as Book; // replace "{} as Book" with what you see is fit
}
...
function printBookTitleAndYear(book: Book): string {
  // write your code here...
  let bookTitle = `${book.title} ${book["publishedYear"]}`;
  return bookTitle; // replace empty string with what you see is fit
}
